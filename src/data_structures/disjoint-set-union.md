...
![Example-image of the set representation with trees](../assets/images/dsu-example.png)
...
![Path compression of call find_set(7)](../assets/images/dsu-path-compression.png)
...
Ứng dụng này khá quan trọng, bởi vì bài toán gần như tương tự xuất hiện trong [Thuật toán Kruskal để tìm cây khung nhỏ nhất](../graph/mst-kruskal.md).
Sử dụng DSU, chúng ta có thể [cải thiện](../graph/mst-kruskal-with-dsu.md) độ phức tạp $O(m \log n + n^2)$ thành $O(m \log n)$.
...
Thuật toán để tìm LCA được thảo luận trong bài viết [Tổ tiên chung thấp nhất - Thuật toán offline của Tarjan](../graph/lca-tarjan.md).
Thuật toán này so sánh thuận lợi với các thuật toán khác để tìm LCA do sự đơn giản của nó (đặc biệt là so với một thuật toán tối ưu như thuật toán từ [Farach-Colton và Bender](../graph/lca-farachcoltonbender.md)).
