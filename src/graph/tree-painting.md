...
Ở đây chúng ta sẽ mô tả một giải pháp khá đơn giản (sử dụng [segment tree](../data_structures/segment-tree.md)) sẽ trả lời mỗi truy vấn trong thời gian $O(\log N)$.
