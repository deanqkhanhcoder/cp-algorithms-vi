...
Vì một luồng bão hòa phải là một luồng cực đại, nó có thể được tìm thấy bởi bất kỳ thuật toán luồng cực đại nào, như [thuật toán Edmonds-Karp](edmonds_karp.md) hoặc [thuật toán Push-relabel](push-relabel.md).
