...
Nhiệm vụ này có thể được giải quyết bằng thuật toán được mô tả với thời gian $O(n^2)$ và bộ nhớ $O(n)$, điều này không thể thực hiện được với [thuật toán Kruskal](mst-kruskal.md).
