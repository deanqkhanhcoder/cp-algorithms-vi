...
Nhiều thuật toán trong lý thuyết số, như [kiểm tra số nguyên tố](primality-tests.md) hoặc [phân tích thừa số nguyên](factorization.md), và trong mật mã, như RSA, yêu cầu rất nhiều phép toán modulo với một số lớn.
